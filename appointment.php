...
<body>
    ...
    <?php if(isset($_SESSION['user'])) {
        ...
        $sql = "SELECT d.doctor_name,  ds.schedule_date, a.*, u.user_first_name, u.user_last_name
                ...
                AND a.user_email = u.user_email AND u.user_email = '$user_email'
        ...
        if ($rows == 0) {
            ...
            ?>
                <tr>
                    ...
                    <td>
    <a class="report" href="doctor-site/view_status.php?appointment_id=<?php echo $rows['appointment_id']?>" style="background-color: green;">Download</a>
</td>
    ...
    <a href="makeappointment.php" id="appointment_link">Make a New Appointment</a><br><br><br>
