            ...
            <div class="doctor-information-column">
                <div class="doctor-information1">
                    <div class="doctor-image">
                        <?php  
                        if ($row['doctor_portrait'] != ""){
                            echo '<img src="data:image/jpg;base64,' . base64_encode($row['doctor_portrait']) . 
                            '" width="100px" height="auto" />'; 
                        } else {
                            echo  "<img src='media/1234.jpg'/>";
                        } ?>
                    </div>
                ...
                <div class="time-selector">
                    ...
                    if (isset($_GET['date'])) {
                        ...
                        $sql = "SELECT a.appointment_time 
                                ...
                                WHERE doctor_id = $doc_id AND a.doc_schedule_id = ds.doc_schedule_id AND schedule_date = '$date'";    
                        $result = mysqli_query($con, $sql);
                        ...
                        $sql = "SELECT * FROM doctor_schedule WHERE doctor_id = $doc_id AND date(schedule_date) = '$date' ORDER BY sche_start_time";    
                        $result = mysqli_query($con, $sql);
                        $row = mysqli_fetch_array($result);
                        if ($row != 0) {    
                            foreach ($result as $row) {
