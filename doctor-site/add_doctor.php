...
<body>
    <div id="main-content">
	<div class="cssstyle">
	<p style="text-align:center">Please fill the details</p>
  ...
  <br>
            ...
            <button class="button" type="cancel" name="cancel" onclick="location.href = 'doctor(login).php';" >Cancel</button><br><br>
        </div>
    </div>
</form>
<script>
